<?php
class ControllerModuleRozetkaEc extends Controller {			
	/**
	...
	public function __construct($registry) {
		...
		$this->load->language('module/rozetka_ec');
		$this->load->model('module/rozetka_ec');
	...
	public function getLinkPay($order_id) {		
		...
		$products = $this->model_module_rozetka_ec->getDefaultOrderProducts($order_id);
	...
	public function success() {		
		...
		$data['redirect_fail'] = $this->url->link('module/rozetka_ec/failPay', '', 'SSL');
		$data['query_url'] = $this->url->link('module/rozetka_ec/checkStatusPay', 'order_id=' . $order_id, 'SSL');
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/rozetka_ec_js.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/module/rozetka_ec_check.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/module/rozetka_ec_check.tpl', $data));
		}
	}
	...
	public function getFooterJs() {
		if($this->config->get('rozetka_ec_status')) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/rozetka_ec_js.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/rozetka_ec_js.tpl', $data);
			} else {
				return $this->load->view('default/template/module/rozetka_ec_js.tpl', $data);
			}
		}
	}
	...
	private function getButtonPay() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/rozetka_ec_button_pay.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/rozetka_ec_button_pay.tpl', $data);
		} else {
			return $this->load->view('default/template/module/rozetka_ec_button_pay.tpl', $data);
		}
	}
