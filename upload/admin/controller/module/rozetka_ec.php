...
class ControllerModuleRozetkaEc extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/rozetka_ec', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('module/rozetka_ec', 'token=' . $this->session->data['token'], true);
		...
		$data['clear_log'] = $this->url->link('module/rozetka_ec/clearlog', 'token=' . $this->session->data['token'], true);
		$data['download_log'] = $this->url->link('module/rozetka_ec/downloadLog', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('module/rozetka_ec.tpl', $data));
	}
	...
	public function clearlog() {
		...
		$this->response->redirect($this->url->link('module/rozetka_ec', 'token=' . $this->session->data['token'], true));
	}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/rozetka_ec')) {
	...
	public function getInfoPayment() {
		...
		$this->response->setOutput($this->load->view('module/rozetka_ec_info.tpl', $data));
	}
	...
	public function paymentRefund() {
		...
		if(!empty($this->request->get['rozetka_uuid'])) {
			$order_id = $this->model_module_rozetka_ec->getOrderId($this->request->get['rozetka_uuid']);
	...
	public function install() {
		$this->model_module_rozetka_ec->install();
	}
	...
	public function uninstall() {
		$this->model_module_rozetka_ec->uninstall();
	}
